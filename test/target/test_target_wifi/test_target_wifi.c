...
#define WIFI_SSID "MartyPartyPhone"
#define WIFI_PASSWORD "123456789"
#define TCP_SERVER "172.20.10.2" // should be running and in echo mode for the test to pass. 
#define TCP_PORT 23
...
void test_get_ip(){
    char ip[60];
    TEST_ASSERT_EQUAL(WIFI_OK, wifi_command_get_ip_from_URL("google.com", ip));
}
